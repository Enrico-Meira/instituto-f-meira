...
?>
    ...
    <main>
            <div class="location">
                ...
                <div class="lct-div">
                    ...
                    <div class="flex-lct">
                        ...
                        <p>A sofisticação do espaço reflete o compromisso com o cuidado pessoal e a busca pela harmonia interior, proporcionando aos clientes uma experiência estética que transcende o físico, abraçando também o aspecto emocional e mental.</p>
            ...
            <div class="evidence">
                ...
                <div class="evd-flex">
                    <div class="evd-card">
                        <div class="evd-imgRow">
                            <img class="virgula" src="<?php echo baseurl; ?>/src/imagens/virgula.png">
                            <img class="evd-img" src="<?php echo baseurl; ?>/src/imagens/Sample_User_Icon.png">                        
                        </div>
                        <div class="evd-txtColumn">
